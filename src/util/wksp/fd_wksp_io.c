...
fd_wksp_checkpt( fd_wksp_t *  wksp,
  ...
  switch( style ) {
  case FD_WKSP_CHECKPT_STYLE_V1: return fd_wksp_private_checkpt_v1( wksp, path, mode, uinfo );
  case FD_WKSP_CHECKPT_STYLE_V2: return fd_wksp_private_checkpt_v2( wksp, path, mode, uinfo, FD_CHECKPT_FRAME_STYLE_RAW );
  case FD_WKSP_CHECKPT_STYLE_V3: return fd_wksp_private_checkpt_v2( wksp, path, mode, uinfo, FD_CHECKPT_FRAME_STYLE_LZ4 );
  break;
  }
...
fd_wksp_restore( fd_wksp_t *  wksp,
  ...
  case FD_WKSP_CHECKPT_STYLE_V1: return fd_wksp_private_restore_v1( wksp, path, new_seed );
  case FD_WKSP_CHECKPT_STYLE_V2: return fd_wksp_private_restore_v2( wksp, path, new_seed );
