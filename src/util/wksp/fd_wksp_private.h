...
/* fd_wksp_private_{checkpt,restore,printf}_v1 provide the v1
   ...
   positive and the verbose 0 information has already been printed. */

int
fd_wksp_private_checkpt_v1( fd_wksp_t *  wksp,
                            char const * path,
                            ulong        mode,
                            char const * uinfo );

int
fd_wksp_private_restore_v1( fd_wksp_t *  wksp,
                            char const * path,
                            uint         new_seed );
...
int
fd_wksp_private_checkpt_v2( fd_wksp_t *  wksp,
                            char const * path,
                            ulong        mode,
                            char const * uinfo,
